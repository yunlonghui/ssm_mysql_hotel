...
<form class="layui-form">
    ...
    <blockquote class="layui-elem-quote list_search">
        <div class="layui-inline">
            <!--&#xe608就是 一个加号的图标-->
            <a class="layui-btn layui-btn-normal catalogAdd_btn"><i class="layui-icon">&#xe608;</i>添加房间类别 </a>
        </div>
    </blockquote>


    <table class="layui-table  layui-table-cell " lay-skin="row"
           id="catalogList" lay-filter="test" ></table>  <!--加载管理员列表数据-->

</form>
<script type="text/javascript" src="${ctx }/layui/layui.js"></script>
<script type="text/javascript" src="${ctx }/js/room/roomCatalog.js"></script>
