...
<table class="layui-table layui-table-cell" id="commentList" lay-filter="test"></table>  <!--加载管理员列表数据-->
<script type="text/javascript" src="${ctx }/layui/layui.js"></script>
<script type="text/javascript" src="${ctx }/js/comment/commentList.js"></script>
