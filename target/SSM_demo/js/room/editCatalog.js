...
layui.config({
    ...
    $=layui.jquery;
    form.on("submit(editCatalog)",function (data) {
        //弹出loading
        ...
        setTimeout(function () {
            ...
            top.layer.msg("房间类别修改成功", { shift: -1, time: 2000 },function () {
    ...
    //角色名称唯一性校验
    $("#catalog").blur(function () {  //失去焦点 调用函数
        //layer.msg($("#roleName").val());
        $.ajax({
            type:"get",
            url:ctx+"/room/checkCatalogName/"+$("#catalog").val(),
