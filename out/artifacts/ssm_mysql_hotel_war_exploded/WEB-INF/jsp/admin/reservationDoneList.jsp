...
<table class="layui-table layui-table-cell" id="reservationDoneList" lay-filter="test"></table>  <!--加载管理员列表数据-->
<script type="text/javascript" src="${ctx }/layui/layui.js"></script>
<script type="text/javascript" src="${ctx }/js/admin/reservationDone.js"></script>
...
<script type="text/html" id="barEdit">
    <a class="layui-btn layui-btn-sm" lay-event="check_out">
