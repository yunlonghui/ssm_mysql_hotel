...
//下面四个时间选择器 改的很简单就是 后面的不能比前面的小就行了
    ...
    table.render({
        ...
        limits:[10,20,30,40],
        cols:[[
            {field:'user_id',title:'会员编号',align:'center',width:80},
            {field:'photo_path',title:'会员头像',align:'center',width:110,templet: "#imgtmp"},
            {field:'username',title:'会员用户名',align:'center',width:110},
            {field:'realname',title:'会员真实姓名',align:'center',width:110},
            ...
            {field:'create_time',title:'注册时间',align:'center',width:160,
                templet:'<div>{{ formatTime(d.create_time,"yyyy-MM-dd hh:mm:ss")}}</div>'},
